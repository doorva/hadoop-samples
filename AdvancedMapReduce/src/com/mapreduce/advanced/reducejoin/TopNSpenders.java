...
public class TopNSpenders {
	/**
	 * 
	 * Usage:
	 * hadoop jar TopNSpenders.jar /MyProjects/CustomerTransactionJoinOutput/part-r-00000 /MyProjects/TopNSpenderOutput 1
	 * 
	 * @param args
	 * @throws IOException
	...
	public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException  {
		...
		job.setJarByClass(TopNSpenders.class);
		job.setNumReduceTasks(1);
		job.setJobName("Top N highest spending customers");
